...
> Inspired by [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) by Maciek. See
> [how the two differ](#how-it-differs-from-claude-code-usage-monitor).
...
## How it differs from Claude Code Usage Monitor

This project borrows the look and feel (and the repository layout) of
[Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor), but answers a narrower question with a
...
Inspired by [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) by Maciek (MIT). No code is
shared; the dashboard style, theme approach and project layout follow its
lead. This project is not affiliated with Anthropic.
